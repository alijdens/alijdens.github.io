...
This is my personal blog. It is based on the [Beautiful Jekyll](https://beautifuljekyll.com/) theme. The blog can be found [here](https://alijdens.github.io).
...
4. Run `bundle install` in the root directory.
5. Run `bundle exec jekyll serve` in the root directory.
